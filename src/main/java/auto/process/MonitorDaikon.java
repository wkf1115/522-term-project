...
public class MonitorDaikon implements Runnable{
    ...
    public void run() {
        ...
        String suffix = (String) yaml.get("daikonCommandSuffix");
        ...
        while (true) {
            ...
            if (fileName != null) {
                ...
                logger.info("now dealing with input : " + sbInput);
                ...
                try {
                    ...
                    StringBuilder sb = new StringBuilder(sbInput.length());
                    for (int i = 0; i < sbInput.toString().length(); i++) {
                        char character = sbInput.toString().charAt(i);
                        if (character != 0) {
                            sb.append(character);
                        }
                    }
                ...
                logger.info("============================================");
                logger.info("Finish trace : " + fileName + "input = " + sbInput + '\n');
                logger.info("============================================");
